export default {
    ...
    ExportDialog_removeInfo_desc: 'Odstranit EXIF informace (například informace o použitém fotoaparátu, nastavení fotoaparátu, lokace apod.)',
    ExportDialog_removeInfo_jpgOnly: 'Další informace jsou pouze pro formát pro JPG (tzn. další informace se exportují pouze v případě, že jak původní fotografie, tak exportovaná fotografie jsou ve formátu JPG).',
