export default {
    ...
    Library_emptyTrash_title: 'Papierkorb ist leer',
    Library_emptyTrash_message: 'Der Papierkorb ist leer. Bitte wähle links oben eine andere Ansicht.',
    Library_emptyView_title: 'Keine Fotos gefunden',
    Library_emptyView_message: 'Diese Ansicht enthält keine Fotos. Bitte wähle links oben eine andere Ansicht.',
    ...
    PhotoActionButtons_photoInfo: 'Informationen über gewähltes Foto zeigen',
    PhotoActionButtons_export: 'Exportieren',

    PhotoInfo_title: 'Infos',
